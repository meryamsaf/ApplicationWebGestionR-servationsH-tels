<%-- 
    Document   : sidebarHotelier
    Created on : 19 févr. 2021, 16:17:34
    Author     : meryam
--%>
...
<body>
	...
	<div class="body">
	  ...
	  <center>  <h1>les réservations effectués</h1></center>
     <table >
                  ...
                  <tr id='header'>
                   ...
                   <th> personne</th>
                    ...
                    <% 
                      ...
                      ArrayList<Reservation> reservations= res.selectBycinhotelier(cin);
                   ...
                   <tr>
                    ...
                    <td><a href="deleteResByHotetier?id=<% out.print(r.getId()); %>"><button>supprimer</button></a></td>
                   </tr><% }%>
     </table>
